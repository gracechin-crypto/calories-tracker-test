...
export default function LoginPage() {
  ...
  return (
    <div className="w-full max-w-sm rounded-card bg-white p-8 shadow-card">
      ...
      <p className="mb-6 mt-1 text-sm font-medium text-sub">Log in to keep your streak going</p>
      ...
      <p className="mt-4 text-center text-sm font-medium text-sub">
        New here?{' '}
        <Link href="/signup" className="font-bold text-green underline underline-offset-2 hover:text-ink">
          Create an account
        </Link>
      </p>
    </div>
